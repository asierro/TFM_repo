...
\usepackage[sorting=none,backend=bibtex,style=phys,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\DeclareUnicodeCharacter{0301}{\hspace{0.25em}}
...
\thesistitle{Computational design of functionalized nanoporous graphene for molecular switching} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
