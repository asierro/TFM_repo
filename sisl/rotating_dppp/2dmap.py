...
for i, ang1 in enumerate(range(0, 95, 5)):
    ...
    with open('energies_val_{}.txt'.format(ang1), 'r') as file:
...
# #---------------------------------------------------------------------------------------------------
# # Generation of best fit line for minima
...
plt.pcolormesh(ang2_list, ang1_list, E_arr, shading='nearest', cmap='inferno')
