...
c
   ...
   40    continue
         !
         ! NOTE: We have already mixed the up and down
         ! potentials, and in this version we really
         ! want the "down" (averaged) ones
         !
!!!         if (down(i)) then
         if (.true.) then
            do 50 j = 2, nr
   ...
   60       continue
         ...
         !
         ! We have also chosen to do a non-relativistic
         ! calculation. That is encoded in 'id'
         !
