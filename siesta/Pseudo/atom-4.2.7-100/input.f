...
c
      read(5,9030) nameat, icorr, ispp, xc_code
 9030 format(3x,a2,3x,a2,a1,1x,i8)
!
!     Make sure that single-letter atomic symbols are left-adjusted
      nameat = adjustl(nameat)
c
      compat_str = ""
